		...
		<nav>
		  <ul class="nav justify-content-center">
			...
			<li class="nav-item" style="padding-right: 40px; padding-left: 50px; width: 120px">
			  <a class="nav-link" href="index.html"><img id="headerlogo" src="logo4.png" alt="Logo of Flor De Amor"><p id="headerlogotext"><p></a> 
			</li>
			<div class="vl"></div>
			<li class="nav-item">
			  <a class="nav-link" href="services2.html">SERVICES</a>
			</li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              <li>
			  <div class="footer-icon1"><a href="contactus.html"> &nbsp; Contact Us</a> 
			  </div>
			  </li>
              <li> 
